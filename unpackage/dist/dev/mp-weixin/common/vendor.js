...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__2191226",
    appName: "yht-wechat-applet",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"yht-wechat-applet","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!******************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/pages.json ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!**********************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/store/index.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  getters: {},
  mutations: {
    changeIsGetInfo: function changeIsGetInfo(state, payload) {
      // 接受一个状态 true/false
...
/* 35 */
/*!**********************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/utils/utils.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _momentMin = _interopRequireDefault(__webpack_require__(/*! @/utils/moment.min.js */ 36));
...
var utils = {
  ...
  // 时间转换函数
  timeFun: function timeFun(time, nowtime) {
    var timeStr = '';
    if ((0, _momentMin.default)(nowtime).format("YYYYMMDD") == (0, _momentMin.default)(time).format("YYYYMMDD")) {
      // 今天
      timeStr = '今天 ' + (0, _momentMin.default)(time).format("kk:mm");
    } else if ((0, _momentMin.default)(time).format("YYYY") < (0, _momentMin.default)(nowtime).format("YYYY")) {
      // 往年
      timeStr = (0, _momentMin.default)(time).format("YYYY-MM-DD");
    } else {
      // 今年
      timeStr = (0, _momentMin.default)(time).format("MM-DD kk:mm");
    }
  ...
  **/
  formateTime: function formateTime(str, tEx, fixZero) {
    ...
    return tEx.replace(/YY/g, YY).replace(/MM/g, MM).replace(/DD/g, DD).replace(/hh/g, hh).replace(/mm/g, mm).replace(/ss/g, ss);
  },
  /**
    @ method  _fixZero | 给个位数的字符串添加0变成两位数
    **/
  _fixZero: function _fixZero(str) {
    str = str || "0";
    try {
      str = String(str);
  ...
  imgHttps: function imgHttps(str) {
    if (str.indexOf('https:') == 0) {
      str = str.substring(6, str.length);
    }
    return str;
  },
  handleUESImg: function handleUESImg(url, ext) {
    console.log('url', url);
  ...
  imgFormatHttps: function imgFormatHttps(str) {
    // https
    if (str.indexOf('https:') == 0) {
      return str;
      // str = str.substring(6, str.length)
  ...
  // 接口获取手机号
  getPhoneNum: function getPhoneNum(data) {
    var _this = this;
    (0, _api.wxGetWalletInfo)({
      vt: 9,
      pluginCode: 'getWalletInfo'
    }).then(function (res) {
      // console.log('接口获取手机号', res)
      _this.phoneNum = res.getPersonalInfo.data.personalInfo && res.getPersonalInfo.data.personalInfo.userMoblie || '';
      uni.setStorageSync('userMoblie', _this.phoneNum);
      getApp().globalData.userMoblie = _this.phoneNum;
      if (uni.getStorageSync('userMessage')) {
        _this.$store.commit('changeIsGetInfo', true);
      }
    });
  },
  // 获取用户信息
  getUserProfile: function getUserProfile(data) {
    ...
    var that = this;
    this.loginType = data;
    var getType = ['getUserInfo', 'getUserProfile'][this.canIUseGetUserProfile ? 1 : 0]; //获取用户信息方式
    wx.login({
      ...
      success: function success(userProfile) {
        ...
        uni.login({
          success: function success(res_login) {
            ...
            (0, _api.asyncAuthenticate)(jsonData).then(function (res) {
              if (res.openId) {
  ...
  authFun: function authFun(userProfile, data) {
    var that = this;
    uni.login({
      success: function success(res_login) {
        // console.log('res_login', res_login)
        ...
        wx.getUserInfo({
          ...
          success: function success(userResult) {
            ...
            var userInfo = JSON.stringify({
              ...
              avatarUrl: encodeURIComponent(userResult.userInfo.avatarUrl),
            ...
            //获取miguToken
            that.$plugin.apiMiguWechatLogin(_objectSpread(_objectSpread({}, loginData), {}, {
              // sourceId: getApp().globalData.sourceId,
              // code: encodeURIComponent(loginResult.code),
              // iv: encodeURIComponent(userResult.iv),
              // enc: encodeURIComponent(userResult.encryptedData),
              ...
              success: function success(result) {
                that.$plugin.getMiguToken({
                  success: function success(miguToken) {
                    console.log('miguToken', miguToken);
                    if (miguToken != null) {
                      // 页面显示  
                      that.miguToken = miguToken;
                      getApp().globalData.userInfo = userResult.userInfo;
                      var jsonData = {
                        reqParams: {
                          code: loginResult.code,
                          userInfo: JSON.stringify(userResult),
                          portalType: '32',
                          miguToken: miguToken
                        }
                      };
                      ...
                      (0, _api.asyncAuthenticate)(jsonData).then(function (res) {
                        ...
                        if (res.resultCode == "1") {
                          ...
                          //登录成功刷新页面
                          that.phoneNum = "咪咕一级登录成功";
                        } else if (res.resultCode == "4401") {
                          that.bindPhone();
                        } else if (res.resultCode == "4402") {
                          uni.hideLoading();
                          uni.showToast({
              ...
              bindmsisdn: function bindmsisdn(bindParam) {
                //需要弹出绑定框
  ...
  aliGetPhone: function aliGetPhone() {
  ...
  getWechatIsOrder: function getWechatIsOrder() {
    return new Promise(function (resolve, reject) {
      (0, _api.wechat_isOrder)({
        'vt': 9
      }).then(function (res) {
        if (res.getOrder && res.getOrder.status == '200') {
          // 1 显示 2不显示  
          var result = res.getOrder.data.paramMap.wechat_isOrder || '2';
  ...
  getOrderAlipay: function getOrderAlipay() {
    return new Promise(function (resolve, reject) {
      (0, _api.wechat_isOrder)({
        'vt': 9
      }).then(function (res) {
        if (res.getOrder && res.getOrder.status == '200') {
          // 1 显示 2不显示  
          var result = res.getOrder_alipay.data.paramMap.wechat_isOrder || '2';
          // this.wechat_isOrder = result;
          resolve(result);
        } else {
          reject(res);
  ...
  DateDiff: function DateDiff(lastTime) {
    // let startTime = new Date('2022-4-20'); // 开始时间
    var startTime = new Date(lastTime); // 开始时间
...
/* 36 */
/*!***************************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/utils/moment.min.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 38 */
/*!********************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/utils/api.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _http = __webpack_require__(/*! ./http.js */ 39);
...
/* 39 */
/*!*********************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/utils/http.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 40 */
/*!********************************************************************!*\
  !*** /Users/lirui/test/yht-wechat-applet/uni.promisify.adaptor.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
